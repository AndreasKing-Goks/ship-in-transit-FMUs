...
from EBASTv2_core.env_multi_configs import EBASTv2EnvMultiConfigs as EBASTv2Env
...
# =========================
# Trained Model Name
model_name                      = "EB-ASTv2_train_rppo_2026-07-26_21-08-37_330c_multi_configs_continue_01"
...
if simulate:
    ...
    config_idx  = None
    seed        = None
    obs, _      = env.reset(seed=seed, specific_case_idx=case_idx, specific_config_idx=config_idx)
