...
def parse_cli_args():
    ...
    parser.add_argument("--model_name", type=str, default="EB-ASTv2_train_1ts", metavar="MODEL_NAME",
                        help="RUN: model/run name used for output folders (default: EB-ASTv2_train_1ts)")
