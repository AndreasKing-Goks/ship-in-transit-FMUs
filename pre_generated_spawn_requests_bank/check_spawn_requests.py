...
for key in spawn_requests.keys():
    print(key)
    print('start_time       : ', spawn_requests[key]['start_time'])
    print('north_route      : ', spawn_requests[key]['north_route'])
    print('east_route       : ', spawn_requests[key]['east_route'])
    print('yaw_angle_deg    : ', spawn_requests[key]['yaw_angle_deg'])
    print('speed_setpoints  : ', spawn_requests[key]['speed_setpoints'])
    print("+++++++++++++++++++++++++++++++++++++++++++++++")
