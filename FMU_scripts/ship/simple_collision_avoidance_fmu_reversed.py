...
class SimpleCollisionAvoidanceReversed(Fmi2Slave):
    ...
    def __init__(self, **kwargs):
        ...
        self.register_variable(Integer("ship_priority_idx", causality=Fmi2Causality.output, variability=Fmi2Variability.discrete))
