...
instance.SetInitalValues(slaveName="THROTTLE_CONTROLLER", 
...
instance.SetInitalValues(slaveName="RUDDER", 
...
instance.SetInitalValues(slaveName="SHIP_MODEL", 
...
instance.SetInitalValues(slaveName="SURFACE_CURRENT", 
...
instance.SetInitalValues(slaveName="WIND", 
                         params=wind_params)
