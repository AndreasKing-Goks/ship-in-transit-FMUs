...
class ShipModel(Fmi2Slave):
    ...
    def __init__(self, **kwargs):
        ...
        self.register_variable(Real("wind_dir", causality=Fmi2Causality.input))
        self.register_variable(Real("current_speed", causality=Fmi2Causality.input))
        self.register_variable(Real("current_dir", causality=Fmi2Causality.input))
        ...
        self.register_variable(Real("yaw_angle", causality=Fmi2Causality.output))
        ...
        self.register_variable(Real("measured_speed", causality=Fmi2Causality.output))
        ...
        self.register_variable(Real("d_yaw_angle", causality=Fmi2Causality.output))
    ...
    def get_wind_force(self, wind_speed, wind_dir, yaw_angle, forward_speed, sideways_speed):
        ...
        '''
        # Unpack wind_args
        uw = wind_speed * np.sin(wind_dir - yaw_angle)
        vw = wind_speed * np.cos(wind_dir - yaw_angle)
    ...
    def three_dof_kinematics(self, yaw_angle, forward_speed, sideways_speed, yaw_rate):
        ...
        dx = np.dot(self.rotation(yaw_angle), vel)
        d_north = dx[0]
        d_east = dx[1]
        d_yaw_angle = dx[2]
        return d_north, d_east, d_yaw_angle
    ...
    def three_dof_kinetics(self, 
        ...
        v_c = np.dot(np.linalg.inv(self.rotation(yaw_angle)), current_velocity)
    ...
    def do_step(self, current_time: float, step_size: float) -> bool:
        ...
        yaw_angle           = self.initial_yaw_angle_rad
        ...
        # Get force
        wind_force          = self.get_wind_force(wind_speed, wind_dir, yaw_angle, forward_speed, sideways_speed)
        current_velocity    = np.array([current_speed * np.cos(current_dir),
        ...
        d_north, d_east, d_yaw_angle                    = self.three_dof_kinematics(yaw_angle,
                                                                                    forward_speed, 
                                                                                    sideways_speed, 
                                                                                    yaw_rate)
        d_forward_speed, d_sideways_speed, d_yaw_rate   = self.three_dof_kinetics(yaw_angle,
                                                                                forward_speed, 
                                                                                sideways_speed, 
                                                                                yaw_rate,
                                                                                thrust_force, 
        ...
        self.yaw_angle                      = yaw_angle      + step_size * d_yaw_angle
        ...
        self.measured_speed                 = np.sqrt(self.forward_speed ** 2 + self.sideways_speed ** 2)
        ...
        self.initial_yaw_angle_rad          = self.yaw_angle
